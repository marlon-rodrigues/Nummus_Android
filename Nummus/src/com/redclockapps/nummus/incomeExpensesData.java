...
public class incomeExpensesData 
{
	...
	//get data to generate text
	public Cursor getDataForText(String month, String year)
	{
		Cursor	 listIncExp;
		
		String orderBy = incExpIsIncome + "," + incExpDate;
		
		listIncExp = db.query(DATABASE_TABLE, new String[] {incExpId, incExpCategory, incExpAmount, incExpDate, incExpAccount, incExpIsIncome}, incExpDate + " LIKE '" + month + "%' AND " + incExpDate + " LIKE '%" + year + "'", null, null, null, orderBy);
	...
	//delete income/expenses from database
	public boolean deleteIncomeExpenses(int idToDelete)
	{
		return db.delete(DATABASE_TABLE, incExpId + "=" + idToDelete, null) > 0;
	}
